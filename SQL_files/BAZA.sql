...
CREATE TRIGGER PRACOWNIK_TRIG AFTER INSERT ON PRACOWNIK FOR EACH ROW
BEGIN
  :NEW.PRACOWNIK_ID := PRACOWNIK_SEQ.NEXTVAL;
  UPDATE KONTO
  SET KONTO.UPRAWNIENIA = 'pracownik' 
  WHERE KONTO.KONTO_ID = :NEW.KONTO_ID;
END;
/
...
AS 
BEGIN 
      INSERT INTO PRACOWNIK(DATA_ZATRUDNIENIA, DATA_ZWOLNIENIA, PENSJA, PREMIA) VALUES (TO_DATE(DATA_ZAT, 'DD/MM/YYYY'), TO_DATE(DATA_ZW, 'DD/MM/YYYY'), PEN, PREM);
