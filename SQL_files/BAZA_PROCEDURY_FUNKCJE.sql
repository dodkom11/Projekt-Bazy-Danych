...
AS 
BEGIN 
    INSERT INTO PRACOWNIK(KONTO_ID, DATA_ZATRUDNIENIA, DATA_ZWOLNIENIA, PENSJA, PREMIA) VALUES (KON_ID, TO_DATE(DATA_ZAT, 'DD/MM/YYYY'), TO_DATE(DATA_ZW, 'DD/MM/YYYY'), PEN, PREM);
